# MERGE_REQUEST / QA paste gate (scale1929).
...
# Distinct from leftover #140 (CONFLICTING vs current main; do not remint
# --name gcs-pr-evidence-gate-beat1849) and cancelled tandem1914 empty-ci.
# Main already has scripts/ci/ship-gate.sh; this gate is paste evidence
# for MERGE_REQUEST / QA, not a second workflow file.
