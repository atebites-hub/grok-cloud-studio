Feature: Grok-bot-like mind plugins (ticket/A2A/cloud) without Hermes (LIV-63)
  Living Sky LIV-63 on PR #47. Grok Build minds get grok-bot-like plugins for
  ...
  mailbox PRs #26 and #28 (envelope, defang, heartbeat). Hive upgrade keeps
  Extra High `cloud_list` / `cloud_followup`. Never Bot CloudAgent.
  ...
  Scenario: Mind GROK_HOME installs ticket, A2A, and cloud grok plugins
    ...
    And ticket, a2a_send / a2a_list_seats, and Extra High cloud tools are available
