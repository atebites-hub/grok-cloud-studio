...
After #47 (command-center Extra High tools) and #76 (mailbox disk turn +
spawn PATH), remaining is grok plugins for ticket / A2A / cloud without
vendoring NousResearch/hermes-agent.

Mail-is-a-turn stays grok mailbox + pin + stay-up, not ACP overlay.
Does not land harvest #26/#28. Does not restack #47 cloud_list /
cloud_followup into mind.py. Never Bot CloudAgent.
