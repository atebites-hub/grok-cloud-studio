...
server.setRequestHandler(ListToolsRequestSchema, async () => ({
  tools: [
    ...
    { name: "cloud_list", description: "List Extra High agents (newest first). Rows print runStatus (RUNNING vs leftover ACTIVE+FINISHED).", inputSchema: { type: "object", properties: { limit: { type: "string" } } } },
