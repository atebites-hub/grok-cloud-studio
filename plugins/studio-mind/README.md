...
still owns taskboard stdio MCP (`taskboard --db`) and Linear HTTP MCP.
...
uses Cursor builtins (shell/files); `ticket`, `scripts/a2a/send.sh`,
`scripts/launch-cloud-extra-high.sh`, and `scripts/cloud/running.sh` stay on PATH.
