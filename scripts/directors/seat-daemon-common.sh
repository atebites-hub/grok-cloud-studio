...
install_mind_grok_plugins() {
  ...
  # Stamp GROK_HOME/gcs-root so copied server.py can import repo scripts
  # after initialize (handshake must not close). Do not vendor Hermes.
  # Do not copy GROK_HOME MCP into Cursor CLI.
  local seat="${1:-}"
