...
def _compose_director_work(task_id: str, context_id: str, text: str) -> str:
    ...
    return (
        ...
        "After you launch, remain this seat. RESULT is duplex, not success. "
        "If you print one: RESULT bc-id=<id or none> pr=<url or none> a2a=<task-id or none> notes=<one line>. "
        "RESULT-only / PONG is a bug. Never launch Bot CloudAgent.\n"
        "\n"
        "MESSAGE:\n"
        f"{text}\n"
    )
