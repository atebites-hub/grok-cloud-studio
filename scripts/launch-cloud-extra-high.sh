...
# LIV-59: --name REFUSE if a live runStatus=RUNNING agent already has that name (no twin remint).
...
# Refuse line must include runStatus= and id= so Floor can follow up, not remint.
