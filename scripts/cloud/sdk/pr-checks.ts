/**
 * GitHub check-run snapshot for Extra High waiter pings (LIV-94 remaining).
 *
 * Empty GitHub checks are not ship-gate evidence. MERGEABLE
 * (mergeable_state=clean) with check_runs=[] is leftover-green theatre.
 * Unique ship-gate YAML is already on origin/main. The required check is
 * named "pytest -q and secret_scan".
 *
 * One-shot GET. Do not reuse Extra High waiter 429 backoff.
